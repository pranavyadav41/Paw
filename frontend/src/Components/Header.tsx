...
function Header() {
  ...
  return (
    ...
    <div className="-m-6 max-h-[768px] w-[calc(100%+48px)] flex-col justify-center">
      <nav className="sticky top-0 z-10 block w-full max-w-full h-[85px]  px-4 py-2 text-white bg-customColor border rounded-none shadow-md h-max border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
