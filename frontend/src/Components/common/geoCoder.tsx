...
const mapboxClient = mbxGeocoding({ accessToken: 'pk.eyJ1IjoiYWtwcmFuYXZ5YWRhdiIsImEiOiJjbHdvZ2l0bHMwbDZ4MnFsYmRpejd4ZHpjIn0.SKiqLTKi43cqyMe7j0Re6A' });
...
const LocationSearch: React.FC<LocationSearchProps> = ({ defaultArea = '', onSelectSuggestion }) => {
